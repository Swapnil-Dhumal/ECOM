...
const AdminProducts = () => {
  ...
  const getAllProductsData = async () => {
    try {
      const response = await fetch("https://ecom-seven-lime.vercel.app/api/admin/products", {
        method: "GET",
        headers: {
  ...
  const deleteProduct = async (id) => {
    try {
      const response = await fetch(`https://ecom-seven-lime.vercel.app/api/admin/products/delete/${id}`, {
        method: "DELETE",
        headers: {
          Authorization: authorizationToken,
        }
